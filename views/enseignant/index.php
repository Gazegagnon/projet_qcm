						...
						<tbody>
							<?php foreach ($questions as $question) { ?>
								<tr>
									...
									<td><p><?= htmlspecialchars($question->getLibelle()) ?></p></td>
					...
					<table>
						...
						<tbody>
							<?php foreach ($reponses as $reponse) { ?>
								<tr>
									<td><p><?= htmlspecialchars($reponse->getReponsePropose()) ?></p></td>
									<td><p><?= htmlspecialchars($reponse->getBonneReponse()) ?></p></td>
									<td><p><?= $reponse->getIdQuestion() ?></p></td>
									<td>
										<a href="delete_personne.php?id=">sup</a>
										<a href="up_personnel.php?id=">Mod</a>
									</td>
